...
import com.kn.fetcher.Fetcher;
import com.kn.generator.Generator;
import com.kn.generator.Injector;
import com.kn.generator.StandardGenerator;
import com.kn.generator.filter.IntervalFilter;
import com.kn.generator.filter.URLRegexFilter;
import com.kn.generator.filter.UniqueFilter;
import com.kn.handler.Handler;
import com.kn.handler.Message;
import com.kn.model.Page;
import com.kn.output.FileSystemOutput;
import com.kn.util.Config;
import com.kn.util.ConnectionConfig;
import com.kn.util.Log;
import com.kn.util.RandomUtils;
...
public class BreadthCrawler {
	...
	private Generator getGenerator() {
		...
		generator = new UniqueFilter(new IntervalFilter(new URLRegexFilter(
				generator, regexs)));
